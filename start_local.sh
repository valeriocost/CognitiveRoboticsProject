...
gnome-terminal --tab -- bash -c 'export PROJECT_HOME=$(pwd); cd webapp; python3 myapp.py'
...
gnome-terminal --window -- bash -c 'export PROJECT_HOME=$(pwd); cd catkin_ws; source devel/setup.bash; roslaunch --wait pepper_nodes tts.launch'
